...
namespace AOC2019.Tests
{
     ...
     * orbits, the orbit maps here are useful for finding efficient
     * routes between, for example, you and Santa. You download a map of
     ...
     * Universal Orbit Map facility uses orbit count checksums - the
     * total number of direct orbits (like the one shown above) and
     * indirect orbits.
     * 
     ...
     *                 I
     *
     * In this visual representation, when two objects are connected by
     * a line, the one on the right directly orbits the one on the left.
     * 
     ...
     * object SAN is orbiting. An orbital transfer lets you move from
    ...
    public class Day06Tests : TestBase
    {
        ...
        public void Day06Example1()
        {
            ...
            var count = Day06.OrbitCounts(inputList);
        ...
        public void Day06Example2()
        {
            ...
            var transfers = Day06.Transfers(inputList);

            transfers.Should().Be(4);
        }
