...
namespace AOC2019.Tests
{
     ...
     * notice that the Space Mail Indicator Light is blinking. To help
     * keep you sane, the Elves have sent you a care package.
     *
     ...
     * won't be hard to build your own - the care package even comes
     * with schematics.
     *
     ...
     * (distance from the top), and tile id. The tile id is interpreted
     * as follows:
     *
     ...
     * 4 is a ball tile. Ball moves diagonally and bounces off objects.
     *
     ...
     * represents the number of quarters that have been inserted; set it
    ...
    {
        public Day13Tests() : base(13)
        {
        }

        [Test]
        public void Part1() =>
            new Day13(input.readAllText())
                .RunGameToEndAndCountBlocks()
                .Should().Be(205);

        [Test]
        public void Part2() =>
            new Day13(gameProgramWith2Quarters())
                .BeatTheGameAndReadTheScore()
                .Should().Be(10292);

        private string gameProgramWith2Quarters() =>
            "2" + input.readAllText().Remove(0, 1);
    }
}
